...
<html lang="en">
  ...
  .star span {
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand logo" href="#page-top"><img src="/festival/img/logo.png" style="width:170px; height:auto"></a>
  ...
  <div class="carousel-inner" style="margin-top: 100px;">
    <div class="carousel-item active">
      <img src="/festival/img/poster1.jpg" width="500px" height="auto" alt="Los Angeles">
    </div>
    <div class="carousel-item">
      <img src="/festival/img/poster2.jpg" width="500px" height="auto" alt="Chicago"> 
    </div>
    <div class="carousel-item">
      <img src="/festival/img/poster3.jpg" width="500px" height="auto" alt="New York">
    </div>
  </div>

  <!-- Left and right controls -->
  <a class="carousel-control-prev" href="#demo" data-slide="prev">
  	<img src="/festival/img/prev.png" width="50px" height="auto">
    </a>
  <a class="carousel-control-next" href="#demo" data-slide="next">
    <img src="/festival/img/next.png" width="50px" height="auto">
  </a>
		...
		<c:forEach var="data" items="${LIST}">
            <div class=" w3-center gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
            	...
            	<div class="w3-border w3-padding">
                	<img src="/festival/img/${data.fno}.jpg" onerror="this.src='/festival/img/poster.png'"
  ...
  <div class="row py-5">
    ...
    <div  class="w3-border w3-padding">
      <a href="">
	      <img src="/festival/img/${RINFO[0].fno}.jpg" alt="" class="img-fluid img-circle" style="width:250px; height: auto;">
      </a>
    </div>
...
<c:forEach var="data" items="${REVIEW1}">
   ...
   <div class="row py-5">
    <div class="col-sm">
       <div  class="w3-border w3-padding">	
    	<a href="">
	      <img src="/festival/img/${RINFO[1].fno}.jpg" alt="" class="img-fluid img-circle" style="width:250px; height: auto;">
    	</a>
	</div>
    </div>
       <div class="col-sm">
